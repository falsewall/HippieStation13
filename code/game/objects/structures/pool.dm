...
//				H << "<span class='notice'>You feel like you swam enough.</span>"
		if(H.swimming == 1)
			...
			H.ExtinguishMob()
			if(H.toxloss > 40 && H.staminaloss > 20 && H.staminaloss < 35) 	 //Heals toxin damage pretty well.
				H.adjustToxLoss(-0.4)
			if(H.fireloss < 21 && H.staminaloss > 20 && H.staminaloss < 35) //Heals light fire damage.
				H.adjustFireLoss(-0.4)
			if(H.bruteloss < 11 && H.staminaloss > 20 && H.staminaloss < 35) //Heals light fire damage.
